...
**Namn på denna komponent:** `elpris_kvart`
...
```bash
ln -s /workspaces/homeassistcore/config/elpris_kvart/custom_components/elpris_kvart /workspaces/homeassistcore/config/custom_components/
```
...
```bash
unlink /workspaces/homeassistcore/config/custom_components/elpris_kvart
```
