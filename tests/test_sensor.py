...
async def test_sensor_value_at_specific_time(hass: HomeAssistant, mock_elpris_api, freezer) -> None:
...
async def test_sensor_update_on_time_change(hass: HomeAssistant, mock_elpris_api, freezer) -> None:
